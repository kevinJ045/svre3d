    ...
    static update() {
        Markers.markers.forEach(marker => {
            if (marker.object3d) {
                ...
                const material = marker.object3d.material;
                ...
                if (marker.line) {
                    ...
                    const endPoint = new THREE.Vector3().copy(playerPosition).add(direction.multiplyScalar(WorldData.get('chunkSize') * Settings.get('renderDistance')));
