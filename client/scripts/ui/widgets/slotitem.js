...
export const SlotItem = ({ item, click = true, counter = true, onClick }) => {
    ...
    return (React.createElement("div", { className: classNames, onClick: onclick, style: iconStyle }, counter && React.createElement("span", { className: "item-count" }, item.quantity)));
};
