...
export const MonoChromeCanvas = (canvas) => {
    const context = canvas.getContext('2d');
    canvas.width = canvas.parentNode.getBoundingClientRect().width;
    canvas.height = canvas.parentNode.getBoundingClientRect().height * 0.95;
    const cellWidth = 10;
    const cellHeight = 10;
...
export const MonotoneBg = () => {
    ...
    return (React.createElement("canvas", { className: 'monochrome-bg', ref: canvasRef }));
};
