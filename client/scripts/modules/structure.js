...
export function generateWithRule(item, rule, seed, object_rules) {
...
function createObject(rule, item, side, seed, parent) {
...
function getRandomPos(position, seed) {
    return new THREE.Vector3(Utils.randFrom(position[0][0], position[0][1], seed), Utils.randFrom(position[1][0], position[1][1], seed), Utils.randFrom(position[2][0], position[2][1], seed));
}
